              ...
              <CarouselContent>
                <CarouselItem>
                  <div className="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-xl transition">
                    ...
                    <p className="text-gray-600 italic">
                      Layanan parkir sangat memudahkan, gate otomatis berjalan
                      lancar dan pembayaran cashless sangat praktis.
                    </p>
                ...
                <CarouselItem>
                  <div className="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-xl transition">
                    ...
                    />
                    <p className="text-gray-600 italic">
                      Sangat profesional, respon cepat, dan sistem monitoring
                      real-time sangat membantu pekerjaan kami.
                    </p>
                    <h4 className="mt-4 font-semibold text-gray-900">
                      Siti Rahma
                    </h4>
                    <span className="text-sm text-gray-500">
                      Direktur Mall Central
                    </span>
                  </div>
                </CarouselItem>
                <CarouselItem>
                  <div className="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-xl transition">
                    ...
                    />
                    <p className="text-gray-600 italic">
                      GB Parking benar-benar membuat pengalaman parkir jauh
