        ...
        <div className="">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {products.map((product, index) => (
              <Card
                key={index}
                className="bg-gradient-to-r from-amber-500 via-white to-blue-300 animate-gradient rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-2 transition duration-300 "
              >
                <img
                  src={product.img}
                  alt={product.name}
